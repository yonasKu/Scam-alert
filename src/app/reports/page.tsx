...
export default function ReportsPage() {
  ...
  const categories = ["All Reports", "Groceries", "Fuel", "Essentials", "Electronics", "Restaurants", "Accommodation", "No Receipt", "Suspicious Activity", "Unauthorized Business"];

  // Filter reports based on active filter
  const filteredReports = reports.filter(report => 
    activeFilter === "All Reports" || 
    report.category === activeFilter ||
    (activeFilter === "No Receipt" && report.reportType === "no_receipt") ||
    (activeFilter === "Suspicious Activity" && report.reportType === "suspicious_activity") ||
    (activeFilter === "Unauthorized Business" && report.reportType === "unauthorized_business")
  );
      ...
      <div style={{
        ...
        <div style={{
          ...
          <p style={{ 
            ...
            View community-submitted reports of price gouging incidents across the country
          </p>
        </div>
